...
const (
	...
	LevelError Level = iota // Has the value 1. this is auto incremented when you use IOTA
	LevelFatal Level = iota // Has the value 2.
	LevelOff   Level = iota // Has the value 3.
)

// If l = 1 then l.String() = "ERROR"
...
func (l *Logger) print(level Level, message string, properties map[string]string) (int, error) {
	...
	// add newline to output after writing log entry
